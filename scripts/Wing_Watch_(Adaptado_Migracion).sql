...
CREATE TABLE IF NOT EXISTS `wingwatch`.`catalogo_orden` (
  ...
  `FECHA_CREACION` DATE NOT NULL,
  `FECHA_MODIFICACION` DATE NOT NULL,
  `catalogo_clase_ID` DECIMAL(10,0) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `wingwatch`.`catalogo_suborden` (
  ...
  `FECHA_CREACION` DATE NOT NULL,
  `FECHA_MODIFICACION` DATE NOT NULL,
  `catalogo_orden_ID` DECIMAL(10,0) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `wingwatch`.`catalogo_familia` (
  ...
  `FECHA_CREACION` DATE NOT NULL,
  `FECHA_MODIFICACION` DATE NOT NULL,
  `catalogo_suborden_ID` DECIMAL(10,0) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `wingwatch`.`catalogo_genero` (
  ...
  `FECHA_CREACION` DATE NOT NULL,
  `FECHA_MODIFICACION` DATE NOT NULL,
  `catalogo_familia_ID` DECIMAL(10,0) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `wingwatch`.`catalogo_especie` (
  ...
  `FECHA_CREACION` DATE NOT NULL,
  `FECHA_MODIFICACION` DATE NOT NULL,
  `catalogo_genero_ID` DECIMAL(10,0) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `wingwatch`.`catalogo_cantidad_huevos` (
  ...
  `NOMBRE_ESPECIE` DECIMAL(10,0) NOT NULL,
  `USUARIO_CREACION` VARCHAR(255) NOT NULL,
  `USUARIO_MODIFICACION` VARCHAR(255) NOT NULL,
  `FECHA_CREACION` DATE NOT NULL,
  `FECHA_MODIFICACION` DATE NOT NULL,
  `catalogo_especie_ID` DECIMAL(10,0) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `wingwatch`.`correo` (
  ...
  `FECHA_CREACION` DATE NOT NULL,
  `FECHA_MODIFICACION` DATE NOT NULL,
  `persona_ID` DECIMAL(10,0) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `wingwatch`.`pajaro_x_persona` (
  ...
  `FECHA_CREACION` DATE NOT NULL,
  `FECHA_MODIFICACION` DATE NOT NULL,
  `catalogo_color_ID` DECIMAL(10,0) NOT NULL,
  `catalogo_zona_vida_ID` DECIMAL(10,0) NOT NULL,
  `persona_ID` DECIMAL(10,0) NOT NULL,
  `catalogo_especie_ID` DECIMAL(10,0) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `wingwatch`.`usuario` (
  ...
  `CEDULA` DECIMAL(10,0) NOT NULL,
  `ES_ADMIN` DECIMAL(10,0) NOT NULL,
  `USUARIO_CREACION` VARCHAR(255) NOT NULL,
  `USUARIO_MODIFICACION` VARCHAR(255) NOT NULL,
  `FECHA_CREACION` DATE NOT NULL,
  `FECHA_MODIFICACION` VARCHAR(255) NOT NULL,
  `tipo_usuario_ID` DECIMAL(10,0) NOT NULL,
  `persona_ID` DECIMAL(10,0) NOT NULL,
  PRIMARY KEY (`ID`),
